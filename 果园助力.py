    ...
    def water(self):
        ...
        for i1 in range(amount1):
            ...
            if rede["ret"][0] == "SUCCESS::调用成功":
               ...
               elif rede["ret"][0] == "FAIL_BIZ_USER_ROLE_INSTANCE_NOT_FOUND::果树实例不存在":

                   print(f"[{self.name}] ❎第{total_watering + 1}次浇水失败: 果树实例不存在")
    ...
    def pk(self):
        def task():
            ...
            data2 = json.dumps({"bizScene": "ORCHARD", "missionCollectionId": "178", "accountPlan": "HAVANA_COMMON",
                               "locationInfos": "[\"{\\\"lng\\\":\\\"104.098238\\\",\\\"lat\\\":\\\"30.229593\\\"}\"]"})
            try:
        ...
        def task1():
            ...
            api = 'mtop.ele.biz.growth.task.core.querytask'
            data2 = json.dumps({"bizScene": "ORCHARD", "missionCollectionId": "178", "accountPlan": "HAVANA_COMMON",
                               "locationInfos": "[\"{\\\"lng\\\":\\\"120.57360671460629\\\",\\\"lat\\\":\\\"99.600419\\\"}\"]"})
            try:
